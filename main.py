...
with torch.no_grad():
	...
	learner.learn(preprocess.resize_with_padding(train_set['data'], 224, 224), train_set['labels'])
	preds = learner.predict(preprocess.resize_with_padding(test_set['data'], 224, 224))
